        ...
        <Card className="border-border/60 bg-card/85">
          <CardContent className="flex flex-col items-center gap-3 px-4 py-5">
            ...
            {selectedDay.summary.freezeUsed ? (
              <div className="flex items-center gap-2 rounded-full border border-secondary/60 bg-secondary/12 px-3 py-1 text-xs text-secondary-foreground dark:text-secondary">
