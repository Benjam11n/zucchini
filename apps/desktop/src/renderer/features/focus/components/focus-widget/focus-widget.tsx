...
import { FocusWidgetControls } from "@/renderer/features/focus/components/focus-widget-controls/focus-widget-controls";
...
export function FocusWidget() {
  ...
  async function handleReset() {
    await resetFocusTimer({
      clearFocusSaveError,
      pomodoroSettings: resolvedPomodoroSettings,
      recordFocusSession: focusWidgetActions.recordFocusSession,
