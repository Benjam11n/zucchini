...
export function InsightsEmptyState({
  ...
  onRetryLoad: InsightsPageActions["insights"]["retryLoad"];
  onSelectRangeDays: InsightsPageActions["insights"]["selectRangeDays"];
  rangeDays: InsightsPageViewModel["rangeDays"];
}) {
  return (
